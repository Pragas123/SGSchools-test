...
const appState = {
  ...
  kraeplinWaktuKolom: [],  // array waktu per kolom
  completed: {
    IST: false,
    KRAEPLIN: false,
    DISC: false,
...
},
{
  ...
  KRAEPLIN: {
    name: "Tes Kraeplin",
    description: "Hitung cepat dan teliti, isi satu kolom dalam 5 detik.",
  ...
  questions: [
    {
      ...
      options: ["Gampangan, Mudah setuju", "Percaya, Mudah percaya pada orang", "Petualang, Mengambil resiko", "Toleran, Menghormati"]
    },
    {
      id: 2,
      text: "Pilih yang PALING (P) dan KURANG (K) menggambarkan diri Anda:",
      options: ["Lembut suara, Pendiam", "Optimistik, Visioner", "Pusat perhatian, Suka gaul", "Pendamai, Membawa Harmoni"]
    },
    {
      id: 3,
      text: "Pilih yang PALING (P) dan KURANG (K) menggambarkan diri Anda:",
      options: ["Menyemangati orang", "Berusaha sempurna", "Bagian dari kelompok", "Ingin membuat tujuan"]
    },
    {
      id: 4,
      text: "Pilih yang PALING (P) dan KURANG (K) menggambarkan diri Anda:",
      options: ["Menjadi frustrasi", "Menyimpan perasaan saya", "Menceritakan sisi saya", "Siap beroposisi"]
    },
    {
      id: 5,
      text: "Pilih yang PALING (P) dan KURANG (K) menggambarkan diri Anda:",
      options: ["Hidup, Suka bicara", "Gerak cepat, Tekun", "Usaha menjaga keseimbangan", "Usaha mengikuti aturan"]
    },
    {
      id: 6,
      text: "Pilih yang PALING (P) dan KURANG (K) menggambarkan diri Anda:",
      options: ["Kelola waktu secara efisien", "Sering terburu-buru, Merasa tertekan", "Masalah sosial itu penting", "Suka selesaikan apa yang saya mulai"]
    },
    {
      id: 7,
      text: "Pilih yang PALING (P) dan KURANG (K) menggambarkan diri Anda:",
      options: ["Tolak perubahan mendadak", "Cenderung janji berlebihan", "Tarik diri di tengah tekanan", "Tidak takut bertempur"]
    },
    {
      id: 8,
      text: "Pilih yang PALING (P) dan KURANG (K) menggambarkan diri Anda:",
      options: ["Penyemangat yang baik", "Pendengar yang baik", "Penganalisa yang baik", "Delegator yang baik"]
    },
    {
      id: 9,
      text: "Pilih yang PALING (P) dan KURANG (K) menggambarkan diri Anda:",
      options: ["Hasil adalah penting", "Lakukan dengan benar, Akurasi penting", "Dibuat menyenangkan", "Mari kerjakan bersama"]
    },
    {
      id: 10,
      text: "Pilih yang PALING (P) dan KURANG (K) menggambarkan diri Anda:",
      options: ["Akan berjalan terus tanpa kontrol diri", "Akan membeli sesuai dorongan hati", "Akan menunggu, Tanpa tekanan", "Akan mengusahakan  yang kuinginkan"]
    },
    {
      id: 11,
      text: "Pilih yang PALING (P) dan KURANG (K) menggambarkan diri Anda:",
      options: ["Ramah, Mudah bergabung", "Unik, Bosan rutinitas", "Aktif mengubah sesuatu", "Ingin hal-hal yang pasti"]
    },
    {
      id: 12,
      text: "Pilih yang PALING (P) dan KURANG (K) menggambarkan diri Anda:",
      options: ["Non-konfrontasi, Menyerah", "Dipenuhi hal detail", "Perubahan pada menit terakhir", "Menuntut, Kasar"]
    },
    {
      id: 13,
      text: "Pilih yang PALING (P) dan KURANG (K) menggambarkan diri Anda:",
      options: ["Ingin kemajuan", "Puas dengan segalanya", "Terbuka memperlihatkan perasaan", "Rendah hati, Sederhana"]
    },
    {
      id: 14,
      text: "Pilih yang PALING (P) dan KURANG (K) menggambarkan diri Anda:",
      options: ["Tenang, Pendiam", "Bahagia, Tanpa beban", "Menyenangkan, Baik hati", "Tak gentar, Berani"]
    },
    {
      id: 15,
      text: "Pilih yang PALING (P) dan KURANG (K) menggambarkan diri Anda:",
      options: ["Menggunakan waktu berkualitas dgn teman", "Rencanakan masa depan, Bersiap", "Bepergian demi petualangan baru", "Menerima ganjaran atas tujuan yg dicapai"]
    },
    {
      id: 16,
      text: "Pilih yang PALING (P) dan KURANG (K) menggambarkan diri Anda:",
      options: ["Pendidikan, Kebudayaan", "Prestasi, Ganjaran", "Keselamatan, keamanan", "Sosial, Perkumpulan kelompok"]
    },
    {
      id: 17,
      text: "Pilih yang PALING (P) dan KURANG (K) menggambarkan diri Anda:",
      options: ["Memimpin, Pendekatan langsung", "Suka bergaul, Antusias", "Dapat diramal, Konsisten", "Waspada, Hati-hati"]
    },
    {
      id: 18,
      text: "Pilih yang PALING (P) dan KURANG (K) menggambarkan diri Anda:",
      options: ["Tidak mudah dikalahkan", "Kerjakan sesuai perintah, Ikut pimpinan", "Mudah terangsang, Riang", "Ingin segalanya teratur, Rapi"]
    },
    {
      id: 19,
      text: "Pilih yang PALING (P) dan KURANG (K) menggambarkan diri Anda:",
      options: ["Saya akan pimpin mereka", "Saya akan melaksanakan", "Saya akan meyakinkan mereka", "Saya dapatkan fakta"]
    },
    {
      id: 20,
      text: "Pilih yang PALING (P) dan KURANG (K) menggambarkan diri Anda:",
      options: ["Memikirkan orang dahulu", "Kompetitif, Suka tantangan", "Optimis, Positif", "Pemikir logis, Sistematik"]
    },
    {
      id: 21,
      text: "Pilih yang PALING (P) dan KURANG (K) menggambarkan diri Anda:",
      options: ["Menyenangkan orang, Mudah setuju", "Tertawa lepas, Hidup", "Berani, Tak gentar", "Tenang, Pendiam"]
    },
    {
      id: 22,
      text: "Pilih yang PALING (P) dan KURANG (K) menggambarkan diri Anda:",
      options: ["Ingin otoritas lebih", "Ingin kesempatan baru", "Menghindari konflik", "Ingin petunjuk yang jelas"]
    },
    {
      id: 23,
      text: "Pilih yang PALING (P) dan KURANG (K) menggambarkan diri Anda:",
      options: ["Dapat diandalkan, Dapat dipercaya", "Kreatif, Unik", "Garis dasar, Orientasi hasil", "Jalankan standar yang tinggi, Akurat"]
    },
    {
      id: 24,
      text: "Pilih yang PALING (P) dan KURANG (K) menggambarkan diri Anda:",
      options: ["Aturan perlu dipertanyakan", "Aturan membuat adil", "Aturan membuat bosan", "Aturan membuat aman"]
    }
  ]
},
...
<div style="text-align:center;margin-top:24px;font-size:1.2em;">
    ...
    document.getElementById('app').innerHTML = `
        <div class="card" id="homeCard">
            ...
            <div id="downloadPDFBox" style="text-align:center;margin-top:45px;opacity:0.4;pointer-events:none;">
                <button class="btn btn-warning"
                    id="btnDownloadPDF"
                    style="padding:18px 42px;font-size:1.17rem;font-weight:700;border:2px solid #29b524;box-shadow:0 0 16px #28ff47,0 0 6px #ff0;opacity:0.8;pointer-events:none;"
                    onclick="generatePDF()">
                  📄 Download Hasil Tes (Partial)
                </button>
            </div>
        </div>
    `;
  ...
  const teks = instruksiList[0];
    ...
    function typeLoop() {
        ...
        if (i < teks.length) {
            ...
            document.getElementById('btnSelesaiInstruksi').style.display = "inline-block";
        }
    }
    typeLoop();
        ...
        <div class="instruction-row">
          <div class="instruction-col">
            ...
            <ul class="compact-list">
              ...
              <li>Kerjakan tiap kolom dalam <b>5 detik</b>.</li>
            </ul>
          </div>
          <div class="instruction-col">
  ...
  for (let c = windowStart; c < windowEnd; c++) {
    ...
    if (!isSelesai && c === activeCol && appState.kraeplinStarted && columns[c].length >= 2) {
      ...
      html += `<div style="display:flex;flex-direction:column;align-items:center;height:100%;margin-left:17px;">
        ...
        <input type="number" class="kraeplin-input-bottom"
          data-col="${c}"
          min="0" max="9" maxlength="1" autocomplete="off" inputmode="numeric"
          value=""
...
if (appState.kraeplinStarted && timeOutEffect) {
  ...
  setTimeout(() => {
    ...
    }, 700); // ← DURASI DANGER DIPERPANJANG DI SINI
  }, 80);
}
...
function isiJawabanKraeplinBottom(el) {
    ...
    if (!appState.isKraeplinTrial) {
        const columns = tests.KRAEPLIN.columns;
        const currentRowIndex = columns[col].length - 2; // Indeks baris yang dijawab
        
        // Inisialisasi array jika belum ada
        if (!appState.answers.KRAEPLIN[col]) {
            // Buat array dengan panjang sesuai jumlah baris awal minus 1
            const initialLength = columns[col].length - 1;
            appState.answers.KRAEPLIN[col] = Array(initialLength).fill(null);
        }
        
        // Simpan jawaban sebagai NUMBER
...
function updateKraeplinTimerDisplay(val) {
  ...
  let display = (val !== undefined ? val : appState.timeLeft || 5) + 's';
...
function finishKraeplinBoard() {
  ...
  if (appState.isKraeplinTrial) {
    ...
    setTimeout(() => alert('Tes Kraeplin selesai. Data sudah terkumpul!'), 300);
  }
}
...
function startKraeplinReal() {
  ...
  appState.currentRow = {};
  appState.kraeplinHistory = {};
  tests.KRAEPLIN.columns = generateKraeplinColumns(10, 20); // 10 kolom real, 20 baris
  generateKraeplinKey();
  renderKraeplinBoard();
}
  ...
  const optionsHTML = question.options.map((option, index) => {
    ...
    return `
      <div class="disc-option${boxClass}" data-index="${index}">
        ...
        <span class="option-text${isP ? ' option-p' : ''}${isK ? ' option-k' : ''}">${option}</span>
      </div>
    `;
  }).join('');
...
function nextDISCQuestion() {
  ...
  appState.answers.DISC.push({
    ...
    p: temp.p,
    k: temp.k,
    pText: question.options[temp.p],
    kText: question.options[temp.k]
  });
  appState.currentQuestion++;
  appState.tempDISC = {};
  appState.discError = "";
